...
import (
	...
	"github.com/linielson/fc2-graphql/graph/generated"
	"github.com/linielson/fc2-graphql/graph/model"
)

func (r *categoryResolver) Courses(ctx context.Context, obj *model.Category) ([]*model.Course, error) {
	var courses []*model.Course

	// in DB: query Courses where Category ID ==
...
func (r *courseResolver) Chapters(ctx context.Context, obj *model.Course) ([]*model.Chapter, error) {
	...
	// in DB: query Chapters where Course ID ==
